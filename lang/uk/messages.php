...
return [
    ...
    'profile' => [
        'updated' => 'Профіль збережено.',
        'password_changed' => 'Пароль змінено.',
        'sessions_revoked' => 'Інші сеанси завершено.',
    ...
    'workspaces' => [
        ...
        'updated' => 'Простір оновлено.',
        'deleted' => 'Простір видалено.',
        'switched' => 'Простір змінено.',
        'personal_exists' => 'Особистий простір у вас уже є.',
        'name_required' => 'Простір компанії потребує назви.',
        'name_empty' => 'Назва простору не може бути порожньою.',
        'delete_name_mismatch' => 'Назва не збігається з назвою простору.',
        'not_owned' => 'Цей простір вам не належить.',
        'slug_format' => 'Адреса може містити лише малі латинські літери, цифри та дефіси.',
        'slug_reserved' => 'Ця адреса зайнята службовою сторінкою — оберіть іншу.',
    ],
